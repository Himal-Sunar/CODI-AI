...
const Login = () => {
  ...
  drop-shadow-[0_0_10px_rgba(200,200,255,0.6)]">
        ...
        <p className="text-zinc-500 text-sm mt-2">Welcome back to the future of coding.</p>
      </div>
      ...
      <div className="relative z-10 mt-8 text-center">
        <p className="text-zinc-400 text-sm">
          ...
          <Link to="/register" className="text-red-500 font-semibold hover:text-red-400 transition-colors">
            Register here
          </Link>
        </p>
      </div>
      
      {/* Small Nepal Flag indicator at bottom */}
      <div className="relative z-10 mt-10 opacity-40 text-[10px] tracking-[0.2em] uppercase text-zinc-500">
        Built with Pride in Nepal 
      </div>
    </div>
  );
}
